...
{
 private  final  String[] month  = {"January", "February", "March", "April", "May", "June", "Jule", "August", "September", "October", "November", "December" };
 private  final  String[] departments = {}; //TODO Заполнить циклом
 ...
 public CalendarFrame()
 {
     ...
     Dimension LeftPanelSize = new Dimension (300, 400);
     ...
     */
     ...
     // Создание панелей
     splitVertical.setTopComponent   (leftPanel);
     splitVertical.setBottomComponent(tabsRight);
